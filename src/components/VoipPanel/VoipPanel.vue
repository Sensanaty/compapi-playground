<template>
  <div
    class="absolute left-8 top-1/4 flex h-[550px] w-[350px] flex-col rounded-3xl border border-gray-500/50 bg-stone-950 shadow shadow-black"
  >
    <TabSwitcher />
...
const { activeVoipTab } = storeToRefs(callStore);
</script>
